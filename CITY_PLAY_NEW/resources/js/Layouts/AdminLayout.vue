        ...
        <aside class="hidden md:flex flex-col w-64 bg-[#2d3436] text-white">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                ...
                <Link 
                    ...
                    class="flex items-center px-4 py-3 rounded-lg transition"
                    :class="route().current('admin.cities.*') ? 'bg-[#d65a31] text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white'"
                >
                ...
                <Link 
                    ...
                    class="flex items-center px-4 py-3 rounded-lg transition"
                    :class="route().current('admin.places.*') || route().current('admin.riddles.*') ? 'bg-[#d65a31] text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white'"
                >
                ...
                <Link 
                    ...
                    class="flex items-center px-4 py-3 rounded-lg transition"
                    :class="route().current('admin.users.*') ? 'bg-[#d65a31] text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white'"
                >
